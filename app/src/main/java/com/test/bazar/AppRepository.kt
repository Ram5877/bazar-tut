...
object AppRepository {
    val appList = (listOf(
        ...
        App(
            ...
            "نسکافه",
            "نسکافه نوشیدنی گرم است که قهوه خور ها مینوشند",
            3000,
            4.8f
        ),
        App(
        ...
        App(
            ...
            "ویالون",
            "ویالون برای نواختن صدای دلنشین است",
            5000,
            4f
        ),
        App(
            ...
            "ارگ",
            "ارگ وسیله ای برای ساختن موسیقی است",
            6000,
            3.5f
        ),
        App(
            ...
            "سیب سبز",
            "سیب سبز یکی از خوشمزه ترین و مفید ترین میوه ها است",
            7000,
            5f
        ),
    )
